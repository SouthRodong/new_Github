...
import com.yum.base.dao.AddressDAO;
import com.yum.base.dao.AddressDAOImpl;
...
public class AddressDAOImpl implements AddressDAO{
	...
	public ArrayList<AddressBean> selectRoadList(String sido, String sigunguname, String roadname) {
		...
		if(logger.isDebugEnabled()){ logger.debug(" AddressDAOImpl : selectRoadList 시작 "); }
		...
		try {
			...
			if(logger.isDebugEnabled()){ logger.debug(" AddressDAOImpl : selectRoadList 종료 "); }
			return postRoadList;
	...
	public ArrayList<AddressBean> selectSigunguList(String sido) {
		...
		if(logger.isDebugEnabled()){ logger.debug(" AddressDAOImpl : selectSigunguList 시작 "); }
		...
		try {
			...
			if(logger.isDebugEnabled()){ logger.debug(" AddressDAOImpl : selectSigunguList 종료 "); }
	...
	public ArrayList<AddressBean> selectSidoList() {
		// TODO Auto-generated method stub
		if(logger.isDebugEnabled()){ logger.debug(" AddressDAOImpl : selectSidoList 시작 "); }
		...
		try {
			...
			if(logger.isDebugEnabled()){ logger.debug(" AddressDAOImpl : selectSidoList 종료 "); }
			return postSidoList;
		}catch(Exception sqle){
			logger.fatal(sqle.getMessage());
			throw new DataAccessException(sqle.getMessage());
	...
	public ArrayList<AddressBean> selectPostList(String dong) {
		// TODO Auto-generated method stub
		if(logger.isDebugEnabled()){ logger.debug(" AddressDAOImpl : selectPostList 시작 "); }
		...
		try {
			...
			if(logger.isDebugEnabled()){ logger.debug(" AddressDAOImpl : selectPostList 종료 "); }
			return postList;
		}catch(Exception sqle){
			logger.fatal(sqle.getMessage());
			throw new DataAccessException(sqle.getMessage());
